...
const getAllEvents = async (request, response) => {
    try {
        ...
        console.error(error);
        return response.status(500).json({ message: 'There was a problem obtaining events' })
    }
}
...
const getOneEvent = async (request, response) => {
    try {
        ...
        if (event) { // Si lo encuentra, de devuelve el evento
        ...
        console.error(error);
        return response.status(500).json({ message: 'There was a problem obtaining a event' })
    }
}
...
const createEvent = async (request, response) => {
    try {
        ...
        return response.status(200).json({ message: 'Event created successfully.', event: event });
    } catch (error) {
        console.error(error);
        return response.status(500).json({ message: 'There was a problem adding a event.' });
    }
}
...
const updateEvent = async (request, response) => {
    try {
        ...
        console.error(error);
        return response.status(500).json({ message: 'There is a problem updating a event.' });
    }
}
...
const deleteEvent = async (request, response) => {
    try {
        ...
        console.error(error);
        return response.status(500).json({ message: 'There is a problem deleting a event.' })
    }
}
